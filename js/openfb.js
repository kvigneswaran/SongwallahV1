...
var openFB = (function () {
    ...
    function login(scope, success, error) {
        ...
        function loginWindowLoadStart(event) {
            var url = event.url;
            Utility.debug("login window loadstart:" + JSON.stringify(event));
        ...
        function loginWindowExit() {
            ...
            //console.log(JSON.stringify({error: 'user_cancelled', error_description: 'User cancelled login process', error_reason: "user_cancelled"}));
    ...
    function oauthCallback(url) {
        ...
        if (url.indexOf("access_token=") > 0) {
            ...
            Utility.debug("step 2");
            if (loginSuccessHandler) {
            	Utility.debug("step 3");
